...
public class Receiver {
    ...
    private static SmartQQClient client = new SmartQQClient(new MessageCallback() {
        ...
        @Override
        public void onMessage(SmartQQClient client, Message msg) {
            if (!working) {
                return;
            }
            try {
        ...
        @Override
        public void onGroupMessage(SmartQQClient client, GroupMessage msg) {
            if (!working) {
                return;
            }
            try {
        ...
        @Override
        public void onDiscussMessage(SmartQQClient client, DiscussMessage msg) {
            if (!working) {
                return;
            }
            try {
